...
def Band_Reject():
    ...
    if Original_Image.mode == "RGB":
        ...
        Final_Image = Image.merge("RGB",
                                  (Inverse_Red_Channel_Image, Inverse_Green_Channel_Image, Inverse_Red_Channel_Image))
...
def Histogram_Equa():
    ...
    cv.imwrite("equalized.png", equalized_img)

    print("Image Saved")


def Display_Histogram():
    immmmg = Image.open("grayscale.jpg")
...
def Filter_Function(Filter_Par, Size):
    Task_2_image = Image.open("Part_4_Task_2_Picture.jpg")
    ...
    filtered_image.save("Task_2_Image.jpg")

    print("Image Saved")


def Brightness_or_Darkness_Function(mode, value):
    Task_3_image = Image.open("Part_4_Task_3_Picture.jpg")
    ...
    for ro in range(1, rows):
        for co in range(1, columns):
            ...
            Min_Value = min(Min_Value, Avarage)
            Max_Value = min(Max_Value, Avarage)
    ...
    Final_Image.save("Task_3_Image.jpg")
